...
function GoldLabel({ children }: { children: ReactNode }) {
  return (
    <span
      className="inline-flex items-center gap-1.5 text-xs font-black uppercase tracking-widest mb-2"
...
function HeroSection() {
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(160deg,#000 0%,#0d0800 30%,#1a1000 60%,#3d2900 100%)",
      }}
    >
      {/* Animated background */}
      <div className="absolute inset-0 pointer-events-none">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle,rgba(201,148,10,0.4) 0%,transparent 70%)",
          }}
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(circle,rgba(201,148,10,0.3) 0%,transparent 70%)",
          }}
        />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <Reveal>
            ...
            <p className="text-white/60 text-lg mb-8 max-w-lg leading-relaxed">
              The identity intelligence platform that helps you verify
              customers, detect fraud, and make accurate onboarding decisions in
              seconds.
            </p>
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="p-6 space-y-4">
                  ...
                  {/* Chart placeholder */}
                  <div
                    className="h-32 rounded-xl flex items-end justify-between px-4 pb-4 gap-2"
                    style={{
                      background:
                        "linear-gradient(180deg,rgba(201,148,10,0.05),rgba(201,148,10,0.1))",
                    }}
                  >
                  ...
                  <div className="space-y-2">
                    {[
                      "ID Verified - John Smith",
                      "Document uploaded - Sarah Chen",
                      "Face match confirmed - Mike Johnson",
                    ].map((item, i) => (
                      <div
                        key={i}
  ...
  const features = [
    {
      ...
      description:
        "Compare your verification metrics against industry benchmarks and competitors to identify optimization opportunities.",
      preview: [
    ...
    },
    {
      ...
      description:
        "Deep-dive into individual customer profiles with comprehensive identity data and risk indicators.",
      preview: [
    ...
    },
    {
      ...
      description:
        "AI-powered document analysis detects tampering, forgeries, and expired IDs in real-time.",
    ...
    },
    {
      ...
      description:
        "Continuous surveillance of customer accounts with instant alerts for suspicious activity.",
      preview: "Chart",
    },
  ];
  ...
  return (
    <section className="py-20 sm:py-28 bg-white relative overflow-hidden">
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at 50% 0%, rgba(201,148,10,0.05) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <Reveal className="text-center mb-16">
          ...
          <p className="text-black/50 max-w-2xl mx-auto">
            Comprehensive tools to verify, monitor, and understand your
              ...
              >
                <div className="flex items-start gap-4">
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg,rgba(201,148,10,0.1),rgba(201,148,10,0.05))",
                    }}
                  >
                  ...
                  <div className="flex-grow">
                    <h3
                      className="font-black text-lg mb-2 text-black"
                      style={{ fontFamily: "'Georgia',serif" }}
                    >
                      {feature.title}
                    </h3>
                        ...
                        <div className="h-16 flex items-end gap-1">
                          {[30, 50, 40, 70, 60, 80, 75].map((h, idx) => (
                            <div
                              ...
                              style={{
                                height: `${h}%`,
                                background: "rgba(201,148,10,0.3)",
                              }}
                            />
                          ))}
                        </div>
...
function IdentityIntelligenceSection() {
  const capabilities = [
    {
      ...
      desc: "Sub-second identity verification with 99.9% uptime",
    },
    {
      icon: "🎯",
      title: "Precision matching",
      desc: "Advanced algorithms reduce false positives by 85%",
    },
    {
      icon: "🔒",
      title: "Fraud prevention",
      desc: "Detect synthetic identities and document tampering",
    },
  ];
  ...
  return (
    <section
      ...
      style={{
        background: "linear-gradient(160deg,#f7f7f7 0%,#fff 50%,#fafafa 100%)",
      }}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <Reveal>
            ...
            <h2
              className="text-3xl sm:text-4xl font-black text-black mb-6"
              style={{ fontFamily: "'Georgia',serif" }}
            >
              Identity intelligence for fast and accurate onboarding decisions
            </h2>
            <p className="text-black/50 mb-8 leading-relaxed">
              Our AI-powered platform analyzes hundreds of data points to
              deliver instant, accurate identity verification decisions that you
              can trust.
            </p>
            ...
            <div className="space-y-4">
              {capabilities.map((cap, i) => (
                <div
                  ...
                  style={{
                    background: "rgba(201,148,10,0.03)",
                  ...
                  <div className="relative inline-flex items-center justify-center">
                    ...
                    <svg className="w-32 h-32 transform -rotate-90">
                      ...
                      <circle
                        ...
                        strokeWidth="8"
                        fill="none"
                        strokeDasharray={`${0.85 * 351.86} 351.86`}
                        strokeLinecap="round"
                      />
                      <defs>
                        <linearGradient
                      ...
                      >
                        <div
                          ...
                          style={{
                            width: `${item.score}%`,
                            background:
                              "linear-gradient(90deg,#c9940a,#f5d87a)",
                          }}
                        />
                      </div>
                      <span
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-black/50 mb-6">
                  Our AI is trained on diverse datasets to ensure accurate
                  verification across all ethnicities, ages, and document types.
                  No bias, just accurate results.
                </p>
                ...
                {[
                  {
                    ...
                    desc: "Verify identities instantly",
                    img: "https://i.pinimg.com/564x/7a/3d/4e/7a3d4e4e2b9f5f0b6c7e4d1f64b1c6a7.jpg",
                  },
                  {
                    label: "Fraud Detection",
                    desc: "AI-powered fraud prevention",
                    img: "https://i.pinimg.com/564x/2d/4c/3f/2d4c3f5f6d1e3b4a5c7f6d1b2e4c5a6f.jpg",
                  },
                  {
                    label: "Document Verification",
                    desc: "Authenticate documents fast",
                    img: "https://i.pinimg.com/564x/3f/6a/7b/3f6a7b8c4d5e2f1a7b3c4d5e6f7a8b9c.jpg",
                  },
                  {
                    label: "Age Verification",
                    desc: "Compliant age checks",
                    img: "https://i.pinimg.com/564x/4e/7c/1a/4e7c1a2b3d4f5a6c7e8b9c1d2e3f4a5b.jpg",
                  },
                  {
                    label: "Financial Services",
                    desc: "KYC & AML compliance",
                    img: "https://i.pinimg.com/564x/5a/1b/6d/5a1b6d7e8f9c0a1b2c3d4e5f6a7b8c9d.jpg",
                  },
                  {
                    label: "Gaming & Gambling",
                    desc: "Responsible gaming tools",
                    img: "https://i.pinimg.com/564x/6c/3d/4f/6c3d4f5a6b7c8d9e0f1a2b3c4d5e6f7a.jpg",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
                    className="aspect-square rounded-xl flex flex-col items-center justify-end p-3"
                    style={{
                      background: `linear-gradient(135deg, rgba(0,0,0,0.1), rgba(201,148,10,0.2))`,
                      backgroundImage: `url(${item.img})`,
                      backgroundSize: "cover",
                      backgroundPosition: "center",
                    }}
                  >
                    <div className="bg-black/40 w-full rounded-lg p-2 text-center">
        ...
        <Reveal delay={0.2}>
          <div
            ...
            style={{
              background: "linear-gradient(160deg,#000,#0d0800,#1a1000)",
            }}
          >
            <div className="text-center mb-8">
