        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <div className="relative">
              <button
                className="flex items-center gap-1.5 text-white/80 hover:text-white transition-colors px-2 py-1.5 rounded-lg hover:bg-white/5"
              ...
              >
                ...
                <svg
                  className={`w-3 h-3 transition-transform ${langOpen ? "rotate-180" : ""} text-yellow-400`}
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={2.5}
              ...
              {langOpen && (
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(160deg, #0d0900 0%, #2a1c00 100%)",
                    border: "1px solid rgba(201,148,10,0.3)",
